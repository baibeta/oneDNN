...
elseif(UNIX OR MINGW)
    ...
    elseif("${CMAKE_CXX_COMPILER_ID}" STREQUAL "GNU")
	    ...
	    if(DNNL_RISCV_USE_MSA_INTRINSICS)
	        append(DEF_ARCH_OPT_FLAGS "-mmsa")
	    elseif(DNNL_RISCV_USE_RVV_INTRINSICS)
...
if (DNNL_TARGET_ARCH STREQUAL "RV64")
    ...
    if (DNNL_RISCV_USE_MSA_INTRINSICS STREQUAL "1")
	    add_definitions(-DDNNL_RISCV_USE_MSA_INTRINSICS)
    endif()
    message(STATUS "DNNL_RISCV_USE_MSA_INTRINSICS: ${DNNL_RISCV_USE_MSA_INTRINSICS}")
