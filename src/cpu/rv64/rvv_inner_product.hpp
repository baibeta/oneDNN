...
#ifndef RV64V_INNER_PRODUCT_HPP
#define RV64V_INNER_PRODUCT_HPP
...
struct riscv_rvv_inner_product_fwd_t : public primitive_t {
    struct pd_t : public cpu_inner_product_fwd_pd_t {
        using cpu_inner_product_fwd_pd_t::cpu_inner_product_fwd_pd_t;

        DECLARE_COMMON_PD_T("RISCV64GC", riscv_rvv_inner_product_fwd_t);
    ...
    riscv_rvv_inner_product_fwd_t(const pd_t *apd) : primitive_t(apd) {}
